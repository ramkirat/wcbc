    ...
    $('.switcher').click(function() {
        ...
        $('.canvas-graph').each(function() {
            ...
            if (draw_loadfunction == "drawinfograph") {
                ...
                if (title == "asphalt") {
                    if ($(this).data('iconbgcolor') != '') {
                        var iconbgcolor = '#5e6f80';
                    }
                    if ($(this).data('pointhvcolor') != '') {
                        var pointhvcolor = '#5e6f80';
                    }
                }
                if (title == "blue") {
                    if ($(this).data('iconbgcolor') != '') {
                        var iconbgcolor = '#3498db';
                    }
                    if ($(this).data('pointhvcolor') != '') {
                        var pointhvcolor = '#3498db';
                    }
                }
                if (title == "green") {
                    if ($(this).data('iconbgcolor') != '') {
                        var iconbgcolor = '#73b819';
                    }
                    if ($(this).data('pointhvcolor') != '') {
                        var pointhvcolor = '#73b819';
                    }
                }
                if (title == "orange") {
                    if ($(this).data('iconbgcolor') != '') {
                        var iconbgcolor = '#f06739';
                    }
                    if ($(this).data('pointhvcolor') != '') {
                        var pointhvcolor = '#f06739';
                    }
                }
                if (title == "purple") {
                    if ($(this).data('iconbgcolor') != '') {
                        var iconbgcolor = '#8573CD';
                    }
                    if ($(this).data('pointhvcolor') != '') {
                        var pointhvcolor = '#8573CD';
                    }
                }
                if (title == "red") {
                    if ($(this).data('iconbgcolor') != '') {
                        var iconbgcolor = '#E74C3C';
                    }
                    if ($(this).data('pointhvcolor') != '') {
                        var pointhvcolor = '#E74C3C';
                    }
                }
                if (title == "s-blue") {
                    if ($(this).data('iconbgcolor') != '') {
                        var iconbgcolor = '#1ed2ff';
                    }
                    if ($(this).data('pointhvcolor') != '') {
                        var pointhvcolor = '#1ed2ff';
                    }

                }
                if (title == "s-green") {
                    if ($(this).data('iconbgcolor') != '') {
                        var iconbgcolor = '#90c963';
                    }
                    if ($(this).data('pointhvcolor') != '') {
                        var pointhvcolor = '#90c963';
                    }
                }
                if (title == "gray") {
                    if ($(this).data('iconbgcolor') != '') {
                        var iconbgcolor = '#95a5a6';
                    }
                    if ($(this).data('pointhvcolor') != '') {
                        var pointhvcolor = '#95a5a6';
                    }
                }
                if (title == "p-green") {
                    if ($(this).data('iconbgcolor') != '') {
                        var iconbgcolor = '#34D3A4';
                    }
                    if ($(this).data('pointhvcolor') != '') {
                        var pointhvcolor = '#34D3A4';
                    }
                }
